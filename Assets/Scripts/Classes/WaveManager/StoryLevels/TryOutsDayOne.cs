...
public class TryOutsDayOne : WaveLogic, WaveLogicContract {
    ...
    public override void Initialize() {
        ...
        // }));
        // //----------------------------------------------------------------------
        // PerformWaveStates(CreateDelayState("Delay", 1f));
        // //----------------------------------------------------------------------
        ...
        // }));
        // //----------------------------------------------------------------------
        // PerformWaveStates(CreateWaveState("CloudEnter", () => {
        ...
        // }));
        // //----------------------------------------------------------------------
        // PerformWaveStates(CreateWaveState("Lightning Finish", () => {
        ...
        // }));
        // //----------------------------------------------------------------------
        // PerformWaveStates(CreateWaveState("Behold", () => {
        ...
        // }));
        // //----------------------------------------------------------------------
        // PerformWaveStates(CreateWaveState("BeholdEnd", () => {
        //     if(TextboxManager.Instance.HasFinished()) {
        //         Completed();
        //     }
        // }));
