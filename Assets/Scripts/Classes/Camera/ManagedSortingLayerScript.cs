  ...
  public bool dontPerformOwnSorting = false;
    ...
    public void PerformSortingLogic() {
        if(!dontPerformOwnSorting) {
            ...
            int sortingLayerCalculation = CalculateSortingLayerTopRightCorner();
    ...
    public int CalculateSortingLayerTopRightCorner() {
        // Debug.Log("calculating");
        // int sortingLayerCalculation = (int)((this.gameObject.transform.position.x + this.gameObject.transform.position.y) * 100);
        int sortingLayerCalculation = (int)(this.gameObject.transform.position.y * 100) + sortingLayerOffset;
