...
public class StandoffBros : MonoBehaviour {
    ...
    public void StandoffBrosInit(GameObject newBroOne, GameObject newBroTwo, Vector2 newStandoffAnchor) {
        ...
        broOneReference.selectableReference.Reset();
        ...
        broTwoReference.selectableReference.Reset();
    ...
    public void PlayerStoppedStandoff() {
        ...
        broOne.GetComponent<HighlightSelectable>().Reset();
        ...
        broTwo.GetComponent<HighlightSelectable>().Reset();
