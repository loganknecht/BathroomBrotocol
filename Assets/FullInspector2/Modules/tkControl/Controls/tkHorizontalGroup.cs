...
namespace FullInspector {
    public partial class tk<T, TContext> {
        ...
        public class HorizontalGroup : tkControl<T, TContext>, IEnumerable {
            private struct SectionItem : tkCustomEditor {
                ...
                public tkControlEditor GetEditor() {
                    return new tkControlEditor(
                        new tk<SectionItem, tkEmptyContext>.VerticalGroup {
                        new tk<SectionItem, tkEmptyContext>.PropertyEditor("MinWidth"),
                        new tk<SectionItem, tkEmptyContext>.PropertyEditor("FillStrength"),
                        new tk<SectionItem, tkEmptyContext>.PropertyEditor("MatchParentHeight"),

                        new tk<SectionItem, tkEmptyContext>.StyleProxy {
                            Style = new tk<SectionItem, tkEmptyContext>.ReadOnly(),
                            Control =
                                new tk<SectionItem, tkEmptyContext>.VerticalGroup {
                                    new tk<SectionItem, tkEmptyContext>.Label("Runtime Layout Information", FontStyle.Bold,
                                        new tk<SectionItem, tkEmptyContext>.VerticalGroup {
                                            new tk<SectionItem, tkEmptyContext>.HorizontalGroup {
                                                { 130, new tk<SectionItem, tkEmptyContext>.PropertyEditor("Flexible?", "Layout_IsFlexible") },
                                                new tk<SectionItem, tkEmptyContext>.PropertyEditor("FlexWidth", "Layout_FlexibleWidth")
                                            },
                                            new tk<SectionItem, tkEmptyContext>.PropertyEditor("Used Width", "Layout_Width")
                                        })
                            }
                        },

                        new tk<SectionItem, tkEmptyContext>.PropertyEditor("Rule")
                    });
                }
            }
