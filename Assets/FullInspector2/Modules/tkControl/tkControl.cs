...
namespace FullInspector {
    ...
    public class tkEmptyContext {
    }

    public class tk<T> : tk<T, tkEmptyContext> {
    }

    /// <summary>
    /// A modifier can be applied to any tkControl{T}. Typically modifiers are generic
    /// styling components that are universally applicable.
    /// </summary>
    public abstract class tkModifier<T, TContext> {
    ...
    public abstract class tkControl<T, TContext> : tkIControl {
        ...
        /// </summary>
        public tkModifier<T, TContext> Style {
            set {
                Styles = new List<tkModifier<T, TContext>> { value };
            }
        }

        /// <summary>
        /// The list of styles/modifiers that will be applied to the control before/after editing.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public List<tkModifier<T, TContext>> Styles {
            get {
                if (_styles == null) _styles = new List<tkModifier<T, TContext>>();
                return _styles;
            }
            set {
                _styles = value;
        ...
        private List<tkModifier<T, TContext>> _styles;
