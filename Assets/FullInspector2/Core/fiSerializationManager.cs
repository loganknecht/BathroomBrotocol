...
namespace FullInspector.Internal {
    ...
    public static class fiSerializationManager {
        ...
        private static void CheckForReset2(ISerializedObject obj) {
            fiSerializedObjectSnapshot originalData = null;
            if (s_snapshots.TryGetValue(obj, out originalData)) {
                ...
                if (obj.SerializedStateKeys == null || obj.SerializedStateKeys.Count == 0 ||
                    ...
                    obj.SaveState();
                    s_snapshots[obj] = new fiSerializedObjectSnapshot(obj);
                }
            }
        }
    }
