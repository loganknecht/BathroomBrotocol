...
namespace FullInspector.Internal {
    ...
    public static class fiEditorUtility {
        /// <summary>
        /// Sets the given object as dirty. In general, this forces the object to be serialized.
        /// </summary>
        public static void SetDirty(UnityObject unityObject) {
            EditorUtility.SetDirty(unityObject);

            if (unityObject is ISerializedObject) {
                fiEditorSerializationManager.SetDirty((ISerializedObject)unityObject);
            }
        }
